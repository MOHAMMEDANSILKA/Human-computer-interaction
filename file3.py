...
api_on = "https://blynk.cloud/external/api/update?token=zSqj8lYcPrJNOpmUXtUGJeepv3Pl3zkz&v1=1"
api_off = "https://blynk.cloud/external/api/update?token=zSqj8lYcPrJNOpmUXtUGJeepv3Pl3zkz&v1=0"

# Initialize the current API to the "on" state
current_api = api_on
...
while True:
    ...
    if results.multi_hand_landmarks:
        ...
        if is_touch_hold(hand_landmarks):
            ...
            # Toggle between APIs for the next "Touch and hold detected" message
            if current_api == api_on:
                current_api = api_off
            else:
                current_api = api_on
